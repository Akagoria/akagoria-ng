...
namespace akgr {
  ...
  , m_background_shape(resources.notification_background, game->render_manager(), game->resource_manager())
  {
    ...
    m_background_shape.set_location(NotificationLocation);
    m_background_shape.set_origin(NotificationOrigin);
  }
